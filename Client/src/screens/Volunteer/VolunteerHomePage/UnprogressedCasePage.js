                        ...
                        <Animated.View style={[styles.popup, slideUp]}>
                                    ...
                                    <View style={{ flex: 1 }}>
                                        ...
                                        <View style={{ flex: 1, alignItems: "flex-end" }}>
                                            <Button
                                                ...
                                                title={"致電"}
                                                titleStyle={{ color: "#5BC100", fontSize: 22 }}
                                                buttonStyle={{ backgroundColor: "rgba(0, 0, 0, 0)", borderColor: "#5BC100", borderWidth: 2, height: "80%", borderRadius: 8 }}
                            ...
                            <View style={styles.horizontalButtonContainer}>
                                <Button
                                    ...
                                    buttonStyle={{ backgroundColor: "#5BC100", paddingLeft: "5%" }}
                ...
                <Animated.View style={[this.springAnimationXY.getLayout(), { position: "absolute", height: "100%", width: "100%", justifyContent: 'flex-end', }]}>
                    <View style={styles.overlay} onLayout={this.onLayout}>
                        <Image
                            ...
                            style={{ height: 50, width: 50, tintColor: "#5BC100" }}
                        />
